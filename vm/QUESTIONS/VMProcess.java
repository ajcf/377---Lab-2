...
public class VMProcess extends UserProcess {
	...
	protected int handleRead(int a0, int a1, int a2) {
                ...
                // TODO: implement read system call using virtual memory. Remove the next line of code as it is only a place holder.
                return -1;
	}
	...
	protected int handleWrite(int a0, int a1, int a2) {
                checkAddresses(a1, a2);
                // TODO: implement write system call using virtual memory. Remove the next line of code as it is only a place holder.
                return -1;
	}
	...
	public int readVirtualMemory(int vaddr, byte[] data, int offset, int length) {
                ...
                // TODO: implement readVirtualMemory with demanding page. Remove the next line of code as it is only a place holder.
                return -1;
	}
	...
	public int writeVirtualMemory(int vaddr, byte[] data, int offset, int length) {
                checkAddresses(vaddr, length);
                // TODO: implement writeVirtualMemory with demanding page. Remove the next line of code as it is only a place holder.
                return -1;
	}
	...
	public void handleException(int cause) {
		switch (cause) {
            ...
            case Processor.exceptionTLBMiss:
                ...
                //TODO: implement TLB miss handler. Extra Credit Question.
