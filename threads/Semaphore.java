...
public class Semaphore {
    ...
    private static class PongTest implements Runnable {
		PongTest(Semaphore ping, Semaphore pong) {
			this.ping = ping;
			this.pong = pong;
		}
	...
	//new KThread(new PongTest(ping, pong)).setName("pingpong").fork();
